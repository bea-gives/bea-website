...
</svg>`;let i=this.shadowRoot.querySelector("svg");new ResizeObserver(e=>{let s=e[0].contentRect.width,r=e[0].contentRect.height,c=Math.max(s,r);i.style.setProperty("--size",`${c}px`)}).observe(this)}});var Pt=class extends Set{dispatch(t){for(let e of this)e(t)}};var Q,D,Z,tt,et,$t,xt,vt=class extends Pt{constructor(){super();a(this,et);a(this,D,void 0);a(this,Z,void 0);a(this,tt,void 0);a(this,xt,()=>{o(this,tt,requestAnimationFrame(n(this,xt))),o(this,D,window.performance.now()),this.deltaTime=n(this,D)-n(this,Z),this.smoothDeltatime+=(this.deltaTime-this.smoothDeltatime)*.05,this.timeScale=this.deltaTime/n(vt,Q),this.smoothTimeScale=this.smoothDeltatime/n(vt,Q),o(this,Z,n(this,D)),this.dispatch()});R(this,et,$t).call(this),document.addEventListener("visibilitychange",()=>{R(this,et,$t).call(this)})}add(t){return this.size||(R(this,et,$t).call(this),n(this,xt).call(this)),super.add(t)}delete(t){let e=super.delete(t);return this.size||cancelAnimationFrame(n(this,tt)),e}clear(){cancelAnimationFrame(n(this,tt)),super.clear()}},qt=vt;Q=new WeakMap,D=new WeakMap,Z=new WeakMap,tt=new WeakMap,et=new WeakSet,$t=function(){o(this,D,o(this,Z,window.performance.now())),this.deltaTime=n(vt,Q),this.smoothDeltatime=this.deltaTime,this.timeScale=1,this.smoothTimeScale=this.timeScale},xt=new WeakMap,a(qt,Q,1e3/60);var bt=new qt;var Vt=1,Zt=2,Wt=4,te=8,z,k,x,_,S,ee=class extends HTMLElement{constructor(){super();a(this,x);a(this,z,void 0);a(this,k,()=>console.log("DamdomTickerElement.callback needs to be set"));new IntersectionObserver(e=>{let s=!1;for(let r of e)r.isIntersecting&&(s=!0);s?o(this,x,n(this,x,_)&~Zt,S):o(this,x,n(this,x,_)|Zt,S)}).observe(this),document.addEventListener("visibilitychange",()=>{document.hidden?o(this,x,n(this,x,_)|Wt,S):o(this,x,n(this,x,_)&~Wt,S)})}connectedCallback(){o(this,x,n(this,x,_)&~te,S),document.hidden&&o(this,x,n(this,x,_)|Wt,S),n(this,x,_)&Vt||n(this,k).call(this)}disconnectedCallback(){o(this,x,n(this,x,_)|te,S)}play(){o(this,x,n(this,x,_)&~Vt,S)}pause(){o(this,x,n(this,x,_)|Vt,S)}get paused(){return!!n(this,x,_)}set callback(t){bt.delete(n(this,k)),o(this,k,t),n(this,z)||bt.add(n(this,k))}};z=new WeakMap,k=new WeakMap,x=new WeakSet,_=function(){return n(this,z)},S=function(t){n(this,z)!==t&&(o(this,z,t),n(this,z)?bt.delete(n(this,k)):bt.add(n(this,k)))};var ie=ee;var Ft=class{constructor({width:t=1,height:e=1,columns:s=1,rows:r=1,positions:c=!0,normals:l=!0,uvs:h=!0,indices:d=!0,facingUp:p=!1}={}){let b=s+1,T=r+1;c&&(this.positions=new Float32Array((s+1)*(r+1)*3)),l&&(this.normals=new Float32Array((s+1)*(r+1)*3)),h&&(this.uvs=new Float32Array((s+1)*(r+1)*2));for(let u=0;u<T;u++){let m=1-u/r,f=(u/r*e-e*.5)*(p?-1:1);for(let E=0;E<b;E++){let y=E/s,L=u*b+E,F=p?2:1;c&&(this.positions[L*3]=y*t-t*.5,this.positions[L*3+F]=f);let A=p?1:2;l&&(this.normals[L*3+A]=1),h&&(this.uvs[L*2]=y,this.uvs[L*2+1]=1-m)}}if(d){let u=s*r*6;u<2**8?this.indices=new Uint8Array(u):u<2**16?this.indices=new Uint16Array(u):this.indices=new Uint32Array(u);for(let m=0;m<r;m++)for(let f=0;f<s;f++){let E=f+b*m,y=f+b*(m+1),L=f+1+b*(m+1),F=f+1+b*m,A=m*s+f;this.indices[A*6]=E,this.indices[A*6+1]=F,this.indices[A*6+2]=y,this.indices[A*6+3]=y,this.indices[A*6+4]=F,this.indices[A*6+5]=L}}}};var yt,Ct,Gt,zt=class{constructor({gl:t,geometry:e=void 0,program:s=void 0}){a(this,yt,void 0);a(this,Ct,void 0);a(this,Gt,void 0);this.gl=t,o(this,Ct,e),o(this,Gt,s);let r=t.getExtension("OES_vertex_array_object");r&&(this.gl.createVertexArray=r.createVertexArrayOES.bind(r),this.gl.bindVertexArray=r.bindVertexArrayOES.bind(r)),o(this,yt,this.gl.createVertexArray()),e&&s&&this.add({geometry:e,program:s})}add({geometry:t=void 0,program:e=void 0}={}){this.bind(),e.attributes.set(t.attributes),t.indices&&t.indices.buffer.bind(),this.unbind()}bind(){this.gl.bindVertexArray(n(this,yt))}unbind(){this.gl.bindVertexArray(null)}};yt=new WeakMap,Ct=new WeakMap,Gt=new WeakMap;var it,nt,st,wt,Et,v,At,O,U,B,Y,H,jt=class{constructor({gl:t,data:e=void 0,width:s=void 0,height:r=void 0,target:c=t.TEXTURE_2D,level:l=0,internalFormat:h=t.RGBA8||t.RGBA,format:d=t.RGBA,type:p=t.UNSIGNED_BYTE,autoGenerateMipmap:b=!0,minFilter:T=b?t.LINEAR_MIPMAP_LINEAR:t.LINEAR,magFilter:u=t.LINEAR,wrapS:m=t.CLAMP_TO_EDGE,wrapT:f=t.CLAMP_TO_EDGE,flipY:E=!1}){a(this,it,void 0);a(this,nt,void 0);a(this,st,void 0);a(this,wt,void 0);a(this,Et,void 0);a(this,v,void 0);a(this,At,0);a(this,O,void 0);a(this,U,void 0);a(this,B,void 0);a(this,Y,void 0);a(this,H,void 0);this.gl=t,o(this,it,this.gl.createTexture()),o(this,nt,s),o(this,st,r),o(this,v,c),this.autoGenerateMipmap=b,this.level=l,this.internalFormat=h,this.format=d,this.type=p,this.minFilter=T,this.magFilter=u,this.wrapS=m,this.wrapT=f,this.flipY=E,this.data=e}generateMipmap(){this.bind(),this.gl.generateMipmap(n(this,v)),this.unbind()}set data(t){this._data=t,this._data&&this._data.length===void 0&&(o(this,wt,this._data.width||this._data.videoWidth),o(this,Et,this._data.height||this._data.videoHeight)),this.bind(),this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL,this.flipY),this.gl instanceof WebGLRenderingContext&&this._data&&this._data.length===void 0?this.gl.texImage2D(n(this,v),this.level,this.internalFormat,this.format,this.type,this._data):this.gl.texImage2D(n(this,v),this.level,this.internalFormat,this.width,this.height,0,this.format,this.type,this._data||null),this.autoGenerateMipmap&&this.gl.generateMipmap(n(this,v)),this.unbind()}get data(){return this._data}set width(t){o(this,nt,t),this.data=this.data}get width(){return n(this,nt)||n(this,wt)}set height(t){o(this,st,t),this.data=this.data}get height(){return n(this,st)||n(this,Et)}set minFilter(t){n(this,H)!==t&&(o(this,H,t),this.bind(),this.gl.texParameteri(n(this,v),this.gl.TEXTURE_MIN_FILTER,n(this,H)),this.unbind())}get minFilter(){return n(this,H)}set magFilter(t){n(this,Y)!==t&&(o(this,Y,t),this.bind(),this.gl.texParameteri(n(this,v),this.gl.TEXTURE_MAG_FILTER,n(this,Y)),this.unbind())}get magFilter(){return n(this,Y)}set wrapS(t){n(this,B)!==t&&(o(this,B,t),this.bind(),this.gl.texParameteri(n(this,v),this.gl.TEXTURE_WRAP_S,n(this,B)),this.unbind())}get wrapS(){return n(this,B)}set wrapT(t){n(this,U)!==t&&(o(this,U,t),this.bind(),this.gl.texParameteri(n(this,v),this.gl.TEXTURE_WRAP_T,n(this,U)),this.unbind())}get wrapT(){return n(this,U)}set flipY(t){n(this,O)!==t&&(o(this,O,t),this.bind(),this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL,n(this,O)),this.unbind())}get flipY(){return n(this,O)}get glTexture(){return n(this,it)}bind({unit:t=0}={}){o(this,At,t),this.gl.activeTexture(this.gl.TEXTURE0+t),this.gl.bindTexture(n(this,v),n(this,it))}unbind({unit:t=n(this,At)}={}){this.gl.activeTexture(this.gl.TEXTURE0+t),this.gl.bindTexture(n(this,v),null)}clone(){return new jt(this)}},Nt=jt;it=new WeakMap,nt=new WeakMap,st=new WeakMap,wt=new WeakMap,Et=new WeakMap,v=new WeakMap,At=new WeakMap,O=new WeakMap,U=new WeakMap,B=new WeakMap,Y=new WeakMap,H=new WeakMap;var rt,ot,q,Rt,Mt,ne,Dt=class{constructor({gl:t,geometry:e=void 0,program:s=void 0}){a(this,Mt);a(this,rt,new Set);a(this,ot,new Map);a(this,q,void 0);a(this,Rt,void 0);this.gl=t,this.geometry=e,this.program=s}get program(){return n(this,q)}set program(t){o(this,q,t),R(this,Mt,ne).call(this)}get geometry(){return n(this,Rt)}set geometry(t){o(this,Rt,t),R(this,Mt,ne).call(this)}get vertexArray(){return n(this,ot).get(this.geometry).get(this.program)}bind(){this.program.use(),this.vertexArray.bind();for(let[t,{type:e}]of this.program.uniformData)if(e.startsWith("sampler")){let s=this.program.uniforms.get(t);s instanceof Nt&&(s.bind({unit:this.program.textureUnits.get(t)}),n(this,rt).add(s))}}draw({mode:t=this.gl.TRIANGLES,bind:e=!1,uniforms:s={},instanceCount:r=void 0,...c}={}){e&&this.bind();for(let[l,h]of Object.entries(s))this.program.uniforms.set(l,h);this.geometry.draw({mode:t,instanceCount:r,...c}),e&&this.unbind()}unbind(){this.vertexArray.unbind();for(let t of n(this,rt))t.unbind(),n(this,rt).delete(t)}};rt=new WeakMap,ot=new WeakMap,q=new WeakMap,Rt=new WeakMap,Mt=new WeakSet,ne=function(){if(!this.program||!this.geometry)return;let t=n(this,ot).get(this.geometry);t||(t=new Map,n(this,ot).set(this.geometry,t)),t.get(n(this,q))||t.set(n(this,q),new zt({gl:this.gl,geometry:this.geometry,program:this.program}))};var $,ht,at=class{constructor({gl:t,data:e=null,target:s=t.ARRAY_BUFFER,usage:r=t.STATIC_DRAW}){a(this,$,void 0);a(this,ht,void 0);this.gl=t,this.target=s,this.usage=r,o(this,$,this.gl.createBuffer()),e&&(this.data=e)}set data(t){o(this,ht,t),this.bind(),this.gl.bufferData(this.target,n(this,ht),this.usage),this.unbind()}get data(){return n(this,ht)}bind({target:t=this.target,index:e=void 0,offset:s=0,size:r=void 0}={}){e===void 0?this.gl.bindBuffer(t,n(this,$)):r===void 0?this.gl.bindBufferBase(t,e,n(this,$)):this.gl.bindBufferRange(t,e,n(this,$),s,r)}unbind({target:t=this.target,index:e=void 0,offset:s=0,size:r=void 0}={}){e===void 0?this.gl.bindBuffer(t,null):r===void 0?this.gl.bindBufferBase(t,e,null):this.gl.bindBufferRange(t,e,null,s,r)}};$=new WeakMap,ht=new WeakMap;var Re=new Map([[WebGLRenderingContext.BYTE,Int8Array],[WebGLRenderingContext.UNSIGNED_BYTE,Uint8Array],[WebGLRenderingContext.SHORT,Int16Array],[WebGLRenderingContext.UNSIGNED_SHORT,Uint16Array],[WebGLRenderingContext.INT,Int32Array],[WebGLRenderingContext.UNSIGNED_INT,Uint32Array],[WebGLRenderingContext.FLOAT,Float32Array]]),Me=new Map([[Int8Array,WebGLRenderingContext.BYTE],[Uint8Array,WebGLRenderingContext.UNSIGNED_BYTE],[Int16Array,WebGLRenderingContext.SHORT],[Uint16Array,WebGLRenderingContext.UNSIGNED_SHORT],[Int32Array,WebGLRenderingContext.INT],[Uint32Array,WebGLRenderingContext.UNSIGNED_INT],[Float32Array,WebGLRenderingContext.FLOAT],[Float64Array,WebGLRenderingContext.FLOAT]]),Tt,I=class{constructor({gl:t,data:e=null,target:s=t.ARRAY_BUFFER,size:r=1,componentType:c=Me.get(e instanceof at?(T=>(T=e.data)==null?void 0:T.constructor)():e==null?void 0:e.constructor),byteOffset:l=0,normalized:h=!1,byteStride:d=0,count:p=(e==null?void 0:e.length)/r||1,divisor:b=0}){a(this,Tt,void 0);this.gl=t,this.data=e,this.size=r,this.componentType=c,this.byteOffset=l,this.normalized=h,this.byteStride=d,this.count=p,this.divisor=b,o(this,Tt,e instanceof at?e:new at({gl:t,data:e,target:s}))}get buffer(){return n(this,Tt)}get typedArray(){return new(Re.get(this.componentType))(this.buffer.data,this.byteOffset,this.count*this.size)}};Tt=new WeakMap;var V,W,Ot=class{constructor({gl:t,positions:e=null,normals:s=null,uvs:r=null,attributes:c={},indices:l=null}){a(this,V,void 0);a(this,W,void 0);this.gl=t,this.indices=null,this.gl.getExtension("OES_element_index_uint"),o(this,V,()=>{}),o(this,W,()=>{});let h=this.gl.getExtension("ANGLE_instanced_arrays");h?(o(this,V,h.drawElementsInstancedANGLE.bind(h)),o(this,W,h.drawArraysInstancedANGLE.bind(h))):this.gl.drawElementsInstanced&&(o(this,V,this.gl.drawElementsInstanced.bind(this.gl)),o(this,W,this.gl.drawArraysInstanced.bind(this.gl))),this.attributes=new Map(c instanceof Map?c:Object.entries(c)),e&&this.attributes.set("position",new I({gl:t,data:e,size:3})),s&&this.attributes.set("normal",new I({gl:t,data:s,size:3})),r&&this.attributes.set("uv",new I({gl:t,data:r,size:2}));for(let[d,p]of this.attributes)p instanceof I||this.attributes.set(d,new I({gl:t,...p}));l&&(this.indices=new I({gl:this.gl,target:this.gl.ELEMENT_ARRAY_BUFFER,...l.length!==void 0?{data:l}:l}))}draw({mode:t=this.gl.TRIANGLES,elements:e=!!this.indices,count:s=e?this.indices.count:this.attributes.get("position").count,offset:r=this.indices?this.indices.byteOffset:0,type:c=e?this.indices.componentType:null,first:l=0,instanceCount:h=void 0}={}){e?h!==void 0?n(this,V).call(this,t,s,c,r,h):this.gl.drawElements(t,s,c,r):h!==void 0?n(this,W).call(this,t,l,s,h):this.gl.drawArrays(t,l,s)}};V=new WeakMap,W=new WeakMap;var se=`#version 300 es
void main() {
...
void main() {
  fragColor = vec4(1.);
}`;var Xt=i=>{let t=new Map,e=new Map,s=/struct\s*(.*)\s*{\s*([\s\S]*?)}/g,r=/^\s*(?:highp|mediump|lowp)?\s*(.[^ ]+) (.[^ ;[\]]+)\[? *(\d+)? *\]?/gm;for(let[,h,d]of i.matchAll(s)){let p={};for(let[,b,T,u]of d.matchAll(r)){let m=parseInt(u);p[T]={type:b,...m?{arrayLength:m}:{}}}e.set(h,p)}let c=/^\s*uniform (?:highp|mediump|lowp)? *(.[^ ]+) (.[^ ;[\]]+)\[? *(\d+)? *\]?/gm,l=(h,d,p=null)=>{let b=e.get(d);if(b){for(let[u,m]of Object.entries(b))l(`${h}.${u}`,m.type,m.arrayLength);return}let T={type:d,...p?{arrayLength:p}:{}};t.set(h,T)};for(let[,h,d,p]of i.matchAll(c))l(d,h,parseInt(p));return t};var Kt=new Map([["float","uniform1f"],["vec2","uniform2fv"],["vec3","uniform3fv"],["vec4","uniform4fv"],["int","uniform1i"],["ivec2","uniform2iv"],["ivec3","uniform3iv"],["ivec4","uniform4iv"],["uint","uniform1ui"],["uvec2","uniform2uiv"],["uvec3","uniform3uiv"],["uvec4","uniform4uiv"],["bool","uniform1i"],["bvec2","uniform2iv"],["bvec3","uniform3iv"],["bvec4","uniform4iv"],["mat2","uniformMatrix2fv"],["mat3","uniformMatrix3fv"],["mat4","uniformMatrix4fv"],["sampler2D","uniform1i"],["samplerCube","uniform1i"]]),w,ct,j,C,G,_t,Lt,X,dt,pt,ut,mt,K,Ut,lt=class{constructor({gl:t,uniforms:e={},vertex:s=se,fragment:r=re,transformFeedbackVaryings:c=void 0}){a(this,K);a(this,w,void 0);a(this,ct,new Map);a(this,j,new Map);a(this,C,"");a(this,G,"");a(this,_t,new Map);a(this,Lt,new Map);a(this,X,new Map);a(this,dt,new Map);a(this,pt,new Map);a(this,ut,void 0);a(this,mt,(t,e)=>{var c;if(e===void 0)return;let s=(c=this.uniformData.get(t.replace(/\[\d*\]/,"")))==null?void 0:c.type;if(e instanceof Object&&!s){for(let l of[...Object.keys(e),...Object.keys(Object.getPrototypeOf(e))])n(this,mt).call(this,e[0]!==void 0?`${t}[${l}]`:`${t}.${l}`,e[l]);return}let r=n(this,pt).get(t);r===void 0&&(r=this.gl.getUniformLocation(n(this,w),t),n(this,pt).set(t,r)),r!==null&&(s.startsWith("mat")?this.gl[Kt.get(s)](r,!1,e):s.startsWith("sampler")?this.gl[Kt.get(s)](r,n(this,j).get(t)):this.gl[Kt.get(s)](r,e))});this.gl=t,o(this,C,s),o(this,G,r),o(this,w,t.createProgram()),o(this,ut,c);let l,h=this.gl.getExtension("ANGLE_instanced_arrays");h?l=h.vertexAttribDivisorANGLE.bind(h):this.gl.vertexAttribDivisor&&(l=this.gl.vertexAttribDivisor.bind(this.gl));let d=this;class p extends Map{set(u,{buffer:m=void 0,location:f=n(d,dt).get(u),size:E=1,componentType:y=t.FLOAT,normalized:L=!1,byteStride:F=0,byteOffset:A=0,divisor:ve=0}={}){if(u instanceof Map){for(let[ye,we]of u)this.set(ye,we);return}m.bind(),f===void 0&&(f=t.getAttribLocation(n(d,w),u),n(d,dt).set(u,f)),f!==-1&&(t.enableVertexAttribArray(f),d.gl instanceof WebGLRenderingContext||y===t.FLOAT||y===t.HALF_FLOAT?(y===t.UNSIGNED_INT&&(y=t.FLOAT),t.vertexAttribPointer(f,E,y,L,F,A)):t.vertexAttribIPointer(f,E,y,F,A),l(f,ve)),m.unbind(),super.set(u,{buffer:m,size:E,componentType:y,normalized:L,byteStride:F,byteOffset:A})}}class b extends Map{set(u,m){var f;return n(f=d,mt).call(f,u,m),super.set(u,m)}}n(this,ut)&&this.gl.transformFeedbackVaryings(n(this,w),n(this,ut),t.SEPARATE_ATTRIBS),R(this,K,Ut).call(this,this.gl.VERTEX_SHADER,n(this,C)),R(this,K,Ut).call(this,this.gl.FRAGMENT_SHADER,n(this,G)),this.attributes=new p,this.uniforms=new b(Object.entries(e))}set vertex(t){o(this,C,t),R(this,K,Ut).call(this,this.gl.VERTEX_SHADER,n(this,C))}get vertex(){return n(this,C)}set fragment(t){o(this,G,t),R(this,K,Ut).call(this,this.gl.FRAGMENT_SHADER,n(this,G))}get fragment(){return n(this,G)}get uniformData(){return n(this,X)}get textureUnits(){return n(this,j)}use(){this.gl.useProgram(n(this,w))}};w=new WeakMap,ct=new WeakMap,j=new WeakMap,C=new WeakMap,G=new WeakMap,_t=new WeakMap,Lt=new WeakMap,X=new WeakMap,dt=new WeakMap,pt=new WeakMap,ut=new WeakMap,mt=new WeakMap,K=new WeakSet,Ut=function(t,e){if(!e)return;if(t===this.gl.VERTEX_SHADER?o(this,_t,Xt(e)):o(this,Lt,Xt(e)),o(this,X,new Map([...n(this,_t),...n(this,Lt)])),this.gl instanceof WebGLRenderingContext)if(e=e.replace(/#version.*?\n/g,""),e=e.replace(/\btexture\b/g,"texture2D"),e=e.replace(/\buvec(.)\b/g,"vec$1"),e=e.replace(/\bflat\b/g,""),t===this.gl.VERTEX_SHADER)e=e.replace(/(^\s*)\bin\b/gm,"$1attribute"),e=e.replace(/(^\s*)\bout\b/gm,"$1varying");else{e=e.replace(/(^\s*)\bin\b/gm,"$1varying");let l=/out vec4 (.*?);/.exec(e);if(l){let h=l[1];e=e.replace(/out.*?;/,""),e=e.replace(new RegExp(`\\b${h}\\b`,"g"),"gl_FragColor")}}let s=this.gl.createShader(t);this.gl.shaderSource(s,e),this.gl.compileShader(s);let r=this.gl.getShaderInfoLog(s);if(this.gl.getShaderParameter(s,this.gl.COMPILE_STATUS))r&&console.warn(r);else{let l=/ERROR: 0:(\d+):/.exec(r);if(l){let h=parseFloat(l[1]),d=e.split(`
...
at: ${d[h-1].replace(/^\s*/,"")}`)}else throw new Error(r)}let c=n(this,ct).get(t);if(c&&(this.gl.detachShader(n(this,w),c),this.gl.deleteShader(c)),this.gl.attachShader(n(this,w),s),this.gl.deleteShader(s),n(this,ct).set(t,s),n(this,ct).size===2){this.gl.linkProgram(n(this,w));let l=this.gl.getProgramInfoLog(n(this,w));if(this.gl.getProgramParameter(n(this,w),this.gl.LINK_STATUS))l&&console.warn(l);else throw new Error(l);n(this,dt).clear(),n(this,pt).clear(),this.use(),n(this,j).clear();let h=0;for(let[d,p]of n(this,X))p.type.startsWith("sampler")&&(n(this,j).set(d,h),h++);if(this.uniforms){for(let d of this.uniforms.keys())n(this,X).has(d)||this.uniforms.delete(d);for(let[d,p]of this.uniforms)n(this,mt).call(this,d,p)}}};var Bt=class extends Dt{constructor({gl:t,width:e=void 0,height:s=void 0,columns:r=void 0,rows:c=void 0,normals:l=!1,uvs:h=!1,attributes:d=void 0,facingUp:p=!1,program:b=new lt({gl:t,vertex:`#version 300 es
